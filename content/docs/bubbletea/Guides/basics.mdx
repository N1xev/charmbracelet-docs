---
title: Tutorial
description: Start Building your first project with bubbletea!
---


<Callout type="info" title="As you know">

Bubble Tea is based on the functional design paradigms of [The Elm Architecture](https://guide.elm-lang.org/architecture/), which happens to work nicely with Go.

This tutorial assumes you have a working knowledge of Go.
</Callout>

By the way, the non-annotated source code for this program is available [on GitHub](https://github.com/charmbracelet/bubbletea/tree/main/tutorials/basics).
