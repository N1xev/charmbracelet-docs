---
title: Commands
description: Learn how to handle I/O operations and asynchronous tasks in Bubble Tea applications using commands and messages
---

import Link from 'next/link'
import Image from 'next/image'

This is the second tutorial for Bubble Tea covering commands, which deal with I/O. The tutorial assumes you have a working knowledge of Go and a decent understanding of [the first tutorial](https://github.com/charmbracelet/bubbletea/tree/master/tutorials/basics).

You can find the non-annotated version of this program [on GitHub](https://github.com/charmbracelet/bubbletea/blob/master/tutorials/commands/main.go).
...
The only thing left to do is run the program, so let's do that! Our initial model doesn't need any data at all in this case, we just initialize it with a `model` struct with default values.
...
After doing this tutorial and [the previous one](https://github.com/charmbracelet/bubbletea/tree/master/tutorials/basics) you should be ready to build a Bubble Tea program of your own. We also recommend that you look at the Bubble Tea [example programs](https://github.com/charmbracelet/bubbletea/tree/master/examples) as well as [Bubbles](https://github.com/charmbracelet/bubbles), a component library for Bubble Tea.

And, of course, check out the [Go Docs](https://pkg.go.dev/github.com/charmbracelet/bubbletea?tab=doc).
