---
title: Table
description: this is table snippet using bubbletea and lipgloss
---
import Image from 'next/image'



<Image src="https://stuff.charm.sh/bubbles-examples/table.gif" unoptimized width={400} height={400} alt="Table Example"/>
...
## Table **(countries and populations)**
